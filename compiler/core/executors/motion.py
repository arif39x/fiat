...
def execute_motion(params: dict) -> dict:
    ...
    for i in range(num_frames):
        ...
        tx = _eval_curve(root_motion.get("translation", {}), t, 0)
        ty = _eval_curve(root_motion.get("translation", {}), t, 1)
        tz = _eval_curve(root_motion.get("translation", {}), t, 2)
...
def _eval_curve(curve: dict, t: float, component: int = 0) -> float:
    if not curve:
        return 0.0
